...
- (void)drawRect:(CGRect)rect
{
  ...
  if (self.tint == FPPopoverNoBorder) {
    CGContextSetFillColorWithColor(ctx, self.contentBackgroundColor.CGColor);
...
-(void)setupViews
{
  ...
  if (self.tint == FPPopoverNoBorder) {
    ...
    contentRect = CGRectMake(contentRect.origin.x-8, contentRect.origin.y-38,
                             contentRect.size.width+17, contentRect.size.height+38+8);
